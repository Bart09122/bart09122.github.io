...
<html lang="es">
	<head>
	    ...
	    <title>GAMETECH SHOP | Signi-in | Signup</title>
...
?>
	...
	<a href="admin/index.php"><button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="admin">Ingresar como administrador</button></a>				
</div>
